package com.patelheggere.locationrecorder.services;
...
import com.patelheggere.locationrecorder.dbhelper.DBManager;
    ...
    private class LocationListener implements android.location.LocationListener
    {
        ...
        public void onLocationChanged(Location location)
        {
            try {
                ...
                String mobil = "9620000944";//auth.getCurrentUser().getPhoneNumber();
