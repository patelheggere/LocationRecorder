...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String WARD_NUMBER = "mWardNumber";
    ...
    private static final String CREATE_TABLE = "create table " + TABLE_NAME + "(" + _ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + WARD_NUMBER + " TEXT , " + VILLAGE_NAME + " TEXT , "+ LAT +" TEXT ," +LON +" TEXT , "+ ELEVATION +" TEXT ," +DATE+" TEXT "+" );";
